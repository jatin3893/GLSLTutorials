...
void GLWidget::initializeGL()
{
    ...
    object2 = new Cube();
    object2->init();
    object2->model.setToIdentity();
    object2->model.translate(2, 1, 0);
}
...
void GLWidget::paintGL()
{
    ...
    QVector3D intensity(1, 1, 1);
    program->setUniformValue("lightPosition", position);
    program->setUniformValue("lightIntensity", intensity);

    program->setUniformValue("model", object->model);
    object->model.rotate(1, 0.4, 0.6, -0.8);
    object->render();

    program->setUniformValue("model", object2->model);
    object2->model.rotate(1, -0.4, 0.6, 0.8);
    object2->render();
}
